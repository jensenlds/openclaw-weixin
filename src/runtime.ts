...
export function setWeixinRuntime(): void {}

/** @deprecated No-op. */
export function getWeixinRuntime(): never {
  throw new Error("Weixin runtime no longer used");
}

/** @deprecated No-op. */
export async function waitForWeixinRuntime(): Promise<never> {
  throw new Error("Weixin runtime no longer used");
}

/** @deprecated No-op. */
export async function resolveWeixinChannelRuntime(): Promise<never> {
  throw new Error("Weixin runtime no longer used");
}
